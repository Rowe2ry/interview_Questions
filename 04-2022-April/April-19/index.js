...
console.log(myIncludes([1,2,3],4)); // true
console.log(myIncludes(['code', 'dev', 'nerd'],'nerd')); // false
console.log(myIncludes(['code', 'dev', 'nerd'],'genius')); // false